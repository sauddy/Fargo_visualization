...
#     print(list_sorted_folder)
    ...
    for folder in list_sorted_folder:
        ...
        dust_gap, dust_num, dust_depth  =  V._get_the_disk_gap('dust1','dens',fraction=dust_fraction, plot=True)
        gas_gap, gas_num,gas_depth  =  V._get_the_disk_gap('gas','dens',fraction=gas_fraction, plot=True)
...
#         gas_depth_list[0] = gas_depth[0]
        ...
        V._time_evol_disk_gap('dust1','dens',fraction=dust_fraction,frequency=1)
        V._time_evol_disk_gap('gas','dens',fraction=gas_fraction,frequency=1)

        ## plotting the gas and dust disk images 
        V._density_plot('dust1','dens',plot_type="2D_polar", fraction=dust_fraction)
        V._density_plot('gas','dens',plot_type="2D_polar", fraction=gas_fraction)
